...
namespace BookLounge.Data.Migrations
{
    ...
    [Migration("20220508165533_adicaoCampoImagem")]
    partial class adicaoCampoImagem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookLounge.Models.Tema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DesignacaoTema")
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("BookLounge.Models.TemaLivro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LivroTFK")
                        .HasColumnType("int");

                    b.Property<int>("TemaFK")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookLounge.Models.TemaLivro", b =>
                {
                    b.HasOne("BookLounge.Models.Livro", "LivroT")
                        .WithMany("ListaTemas")
                        .HasForeignKey("LivroTFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookLounge.Models.Tema", "Tema")
                        .WithMany("ListaLivros")
                        .HasForeignKey("TemaFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
